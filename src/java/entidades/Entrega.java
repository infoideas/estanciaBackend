...
public class Entrega implements Serializable {
    ...
    private double cantidadGarrones;
    private double cantidadPiernas;
    private double cantidadDelanteros;
    private double totalKilos;
    private double valorFlete;
    private String observaciones;
    private List<EntregaDetalle> listaDetalle= new ArrayList<EntregaDetalle>();
    ...
    public double getCantidadGarrones() {
        return cantidadGarrones;
    }

    public void setCantidadGarrones(double cantidadGarrones) {
        this.cantidadGarrones = cantidadGarrones;
    }

    public double getCantidadPiernas() {
        return cantidadPiernas;
    }

    public void setCantidadPiernas(double cantidadPiernas) {
        this.cantidadPiernas = cantidadPiernas;
    }

    public double getCantidadDelanteros() {
        return cantidadDelanteros;
    }

    public void setCantidadDelanteros(double cantidadDelanteros) {
        this.cantidadDelanteros = cantidadDelanteros;
    }
    ...
    public List<EntregaDetalle> getListaDetalle() {
        return listaDetalle;
    }

    public void setListaDetalle(List<EntregaDetalle> listaDetalle) {
